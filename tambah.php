    ...
    <div class="col-md-6 offset-md-3 align-self-center"> 
      ...
      <form method="POST">
        <div class="mb-3">
          ...
          <input type="number" class="form-control" id="inputNis" name="nis" placeholder="Masukan No RM">
        </div>
        <div class="mb-3">
        ...
        <div class="mb-3">
          ...
          <input type="text" class="form-control" id="inputKelas" name="kelas" placeholder="Masukan Alamat pasien">
        </div>
        <div class="mb-3">
          <label for="inputKelas" class="form-label">Diagnossa</label>
          <input type="text" class="form-control" id="inputKelas" name="diagnosa" placeholder="Masukan Diagnosa pasien">
        </div>
        <div class="mb-3">
          <label for="inputKelas" class="form-label">Ruang</label>
          <input type="text" class="form-control" id="inputKelas" name="ruang" placeholder="Masukan Ruang pasien">
        </div>
        <div class="mb-3">
          <label for="inputKelas" class="form-label">Telepon</label>
          <input type="text" class="form-control" id="inputKelas" name="telepon" placeholder="Masukan telepon pasien">
        </div>
